...
import { formatAgeGroups, formatScheduleType } from "@/lib/utils";
  ...
  return (
    <>
      <div className="py-6 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <Link
          href="/find"
          className="text-primary-green hover:underline text-sm font-medium mb-5 inline-block"
        >
          ← Back to Search
        </Link>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          <div className="bg-white rounded-card p-4 sm:p-6 border border-neutral-border">
            <h3 className="font-serif font-bold text-primary-dark mb-2 text-sm sm:text-base">
              Phone
            </h3>
            <a
              href={`tel:${centre.phone}`}
              className="text-primary-green hover:underline text-sm sm:text-base"
            >
              {centre.phone}
            </a>
          </div>
          ...
          <div className="bg-white rounded-card p-4 sm:p-6 border border-neutral-border">
            ...
            <a
              ...
              className="text-primary-green hover:underline text-xs sm:text-sm break-all"
            >
              {centre.email}
            </a>
          </div>
        ...
        <div className="bg-white rounded-card p-5 sm:p-6 border border-neutral-border mb-6">
          <h2 className="text-xl sm:text-2xl font-serif font-bold text-primary-dark mb-3">
            About
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div>
            <h2 className="text-xl sm:text-2xl font-serif font-bold text-primary-dark mb-4">
              Details
            </h2>
            <div className="space-y-3">
              <div className="bg-white rounded-card p-4 border border-neutral-border">
                <h3 className="font-serif font-bold text-primary-dark mb-2 text-sm">
                  Age Groups
                </h3>
              ...
              <div className="bg-white rounded-card p-4 border border-neutral-border">
                ...
                <p className="text-primary-dark font-medium text-sm">
                  {formatScheduleType(centre.scheduleType)}
                </p>
              </div>
        ...
        <div className="bg-white rounded-card p-6 sm:p-8 border border-neutral-border text-center">
          ...
          <p className="text-neutral-muted text-sm mb-5">
            Ask our AI assistant anything about this daycare, schedules,
            programs, or childcare in BC.
          </p>
          <button
